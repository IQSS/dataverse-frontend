...
describe('useGetGuestbooksByCollectionId', () => {
  ...
  it('returns guestbooks when request succeeds', async () => {
    ...
    cy.wrap(getGuestbooksByCollectionIdStub).should('have.been.calledOnceWith', 1, false, false)
  })
  ...
  it('passes includeStats=true when explicitly requested', async () => {
    ...
    cy.wrap(getGuestbooksByCollectionIdStub).should('have.been.calledOnceWith', 1, true, false)
  })

  it('passes includeInherited=true when explicitly requested', async () => {
    const getGuestbooksByCollectionIdStub =
      guestbookRepository.getGuestbooksByCollectionId as Cypress.Agent<sinon.SinonStub>
    getGuestbooksByCollectionIdStub.resolves([guestbook])
    ...
    cy.wrap(getGuestbooksByCollectionIdStub).should('have.been.calledOnceWith', 1, false, true)
  })
