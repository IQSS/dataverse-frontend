...
describe('No Datasets Message', () => {
  it('renders the message for anonymous user', () => {
    ...
    cy.findByText(/This collection currently has no datasets. Please /).should('exist')
  ...
  it('renders the message for authenticated user', () => {
    ...
    cy.findByText(
      'This collection currently has no datasets. You can add to it by using the Add Data button on this page.'
    ).should('exist')
  })
})
