...
describe('Header component', () => {
  ...
  test('displays the user name when the user is logged in', async () => {
    ...
    const { findByText } = render(<Header getCurrentAuthenticatedUser={getCurrentAuthenticatedUserStub} />)
  ...
  test('displays the Sign Up and Log In links when the user is not logged in', async () => {
    ...
    const { getByRole } = render(<Header getCurrentAuthenticatedUser={getCurrentAuthenticatedUserStub} />)
