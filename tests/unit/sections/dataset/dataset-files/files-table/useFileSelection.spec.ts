...
import { useFileSelection, createRowSelection, createFileSelection } from '@/sections/dataset/dataset-files/files-table/row-selection/useFileSelection'
...
describe('useFileSelection', () => {
  ...
  const mockRowModel: Record<string, Row<FilePreview>> = {
    '0': { original: file1 } as unknown as Row<FilePreview>
  }
