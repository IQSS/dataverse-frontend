...
/*
 This is a Layout common to every keycloak page. It was originally generated by running `npx keycloakify eject-page` and then selecting `Template.tsx` option.
*/
