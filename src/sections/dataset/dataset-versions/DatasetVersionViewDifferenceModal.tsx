...
interface DatasetVersionViewDifferenceModalProps {
  show: boolean
  handleClose: () => void

  isLoading: boolean
  errorLoading: string | null
  dataset: DatasetVersionSummaryInfo | null
}

export const DatasetVersionViewDifferenceModal = ({
  show,
  handleClose,
  isLoading,
  dataset
}: DatasetVersionViewDifferenceModalProps) => {
