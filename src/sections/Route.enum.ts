...
export enum Route {
  ...
  COLLECTION_TEMPLATES = '/collections/:collectionId/templates',
  GUESTBOOKS = '/collections/:collectionId/guestbooks',
  GUESTBOOKS_CREATE = '/collections/:collectionId/guestbooks/create',
...
export const RouteWithParams = {
  ...
  COLLECTION_TEMPLATES: (collectionId: string) => `/collections/${collectionId}/templates`,
  GUESTBOOKS: (collectionId: string) => `/collections/${collectionId}/guestbooks`,
  GUESTBOOKS_CREATE: (collectionId: string) => `/collections/${collectionId}/guestbooks/create`,
  EDIT_FILE_METADATA: (
