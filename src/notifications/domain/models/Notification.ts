export enum NotificationType {
  ...
  ASSIGN_ROLE_COLLECTION = 'assignRoleCollection',
  ASSIGN_ROLE_DATASET = 'assignRoleDataset',
  ASSIGN_ROLE_DATAFILE = 'assignRoleDatafile',
  ASSIGN_ROLE_FILE_DOWNLOADER_DATASET = 'assignRoleFileDownloaderDataset',
  ASSIGN_RILE_FILE_DOWNLOADER_COLLECTION = 'assignRoleFileDownloaderCollection',
  REVOKE_ROLE_COLLECTION = 'revokeRoleCollection',
  REVOKE_ROLE_DATASET = 'revokeRoleDataset',
  REVOKE_ROLE_DATAFILE = 'revokeRoleDatafile',
